package br.poup.app.repository;

import br.poup.app.PoupApplicationApp;
import br.poup.app.config.Constants;
import br.poup.app.config.audit.AuditEventConverter;
import br.poup.app.domain.PersistentAuditEvent;
...
import static br.poup.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
