package br.poup.app.web.rest;

import br.poup.app.config.Constants;
import br.poup.app.PoupApplicationApp;
import br.poup.app.domain.Authority;
import br.poup.app.domain.User;
import br.poup.app.repository.AuthorityRepository;
import br.poup.app.repository.UserRepository;
import br.poup.app.security.AuthoritiesConstants;
import br.poup.app.service.MailService;
import br.poup.app.service.dto.UserDTO;
import br.poup.app.web.rest.errors.ExceptionTranslator;
import br.poup.app.web.rest.vm.KeyAndPasswordVM;
import br.poup.app.web.rest.vm.ManagedUserVM;
import br.poup.app.service.UserService;
...
@SpringBootTest(classes = PoupApplicationApp.class)
